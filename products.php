    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Products</h1>
            <span>second hand product wit best price.</span>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="service-item">
              ...
              <div class="down-content">
                ...
                <div style="margin-bottom:10px;">
                  <span>
                      <del><sup>₹</sup><?php echo $row['old_price'];?></del> &nbsp; <sup>₹</sup><?php echo $row['new_price'];?>
                  </span>
                </div>

                <p><?php echo $row['product_specification'];?> </p>
                <a href="product-details.php?product_id=<?php echo $row['id'];?>" class="filled-button">View More</a>
              </div>
            </div>
